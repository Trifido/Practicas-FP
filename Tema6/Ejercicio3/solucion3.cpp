...
double Precio(double distancia, double precio_final){   // Funcion para obtener el precio dependiendo de la distancia.
    if(distancia>1100)
...
int main()
{
    ...
    if(distancia>=200){                                                     // Si distancia es mayor de 200 se calcula el precio por medio
        ...
        precio_final= Precio(distancia, precio_final);      // Llamo a la funcion Precio.
